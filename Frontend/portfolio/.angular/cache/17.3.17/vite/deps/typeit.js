...
var Queue = function(initialItems) {
  let add = function(steps) {
    asArray(steps).forEach((step) => {
      return _q.set(Symbol(step.char?.innerText), buildQueueItem(__spreadValues({}, step)));
    });
    return this;
  };
...
var beforePaint = (cb) => {
  return new Promise((resolve) => {
    requestAnimationFrame(() => __async(void 0, null, function* () {
      resolve(yield cb());
    }));
  });
};
...
var fireItem = (_0) => __async(void 0, [_0], function* ({
  index,
  queueItems,
  wait: wait2,
  cursor,
  ...
  if (instantQueue.length) {
    yield beforePaint(() => __async(void 0, null, function* () {
  ...
  yield wait2(() => __async(void 0, null, function* () {
...
var wait = (callback, delay, timeouts) => {
  return new Promise((resolve) => {
    let cb = () => __async(void 0, null, function* () {
      yield callback();
      resolve();
    });
...
var TypeIt = class {
  ...
  type(string, actionOpts = {}) {
    ...
    let itemsToQueue = [
      bookEndQueueItems[0],
      { func: () => __async(this, null, function* () {
        return yield this.opts.beforeString(string, this);
      }) },
      ...charsAsQueueItems,
      { func: () => __async(this, null, function* () {
        return yield this.opts.afterString(string, this);
      }) },
      bookEndQueueItems[1]
    ];
      ...
      try {
        ...
        for (let index = 0; index < queueItems.length; index++) {
          ...
          if (!queueItem.deletable || queueItem.deletable && this.#allChars.length) {
            let newIndex = yield this.#fireItemWithContext(index, queueItems);
            cleanUpSkipped({
              index,
              newIndex,
              queueItems,
        ...
        this.#wait(() => __async(this, null, function* () {
          yield this.#prepLoop(delay[0]);
          this.#fire();
        }), delay[1]);
      } catch (e) {
      }
  ...
  #prepLoop(delay) {
    return __async(this, null, function* () {
      ...
      derivedCursorPosition && (yield this.#move({ value: derivedCursorPosition }));
      ...
      for (let index = 0; index < queueItems.length; index++) {
        yield this.#fireItemWithContext(index, queueItems);
      }
      this.queue.reset();
  ...
  #wait(callback, delay, silent = false) {
    return __async(this, null, function* () {
      ...
      silent || (yield this.opts.beforeStep(this));
      yield wait(callback, delay, this.timeouts);
      silent || (yield this.opts.afterStep(this));
    });
  }
  /**
